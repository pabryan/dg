...
#+BEGIN_export latex
\begin{center}
\includegraphics[width=\textwidth]{curves/img/unit_circle_example.png}
\end{center}
#+END_export
#+END_env
...
#+BEGIN_export latex
\begin{center}
\includegraphics[width=\textwidth]{curves/img/unit_circle_alt_example.png}
\end{center}
#+END_export
#+END_env
...
#+BEGIN_export latex
\begin{center}
\includegraphics[width=\textwidth]{curves/img/curves_not_reg_abs.png}
\end{center}
#+END_export
#+END_env
...
#+BEGIN_export latex
\begin{center}
\includegraphics[width=\textwidth]{curves/img/curves_not_reg_cusp.png}
\end{center}
#+END_export
#+END_env
...
#+BEGIN_export latex
\begin{center}
\includegraphics[width=\textwidth]{curves/img/curves_regular_non_simple.png}
\end{center}
#+END_export
#+END_env
